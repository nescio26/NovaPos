          ...
          {menus.map((menu) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <h1
                    className={`text-sm font-black uppercase tracking-tighter italic ${isSelected ? "text-white" : "text-[#1A1D21] dark:text-slate-300"}`}
                  >
                    {menu.name}
                  </h1>
                  <p
                    className={`text-[10px] font-black uppercase tracking-widest mt-0.5 ${isSelected ? "text-[#FF5C00]" : "text-slate-400 dark:text-slate-500"}`}
                  >
